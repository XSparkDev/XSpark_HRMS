-- ============================================================================
-- X SPARK HRMS DATABASE SCHEMA - PROGRAMMATIC IMPLEMENTATION
-- ============================================================================
-- This script implements the complete database schema following the
-- implementation plan phases. Execute this to create the entire database.
-- ============================================================================
...
BEGIN
    ...
    AND information_schema.tables.table_name = ANY(expected_tables);
    ...
    ELSE
        ...
        LOOP
            IF NOT EXISTS (
                ...
                WHERE table_schema = 'public' 
                AND information_schema.tables.table_name = expected_table_name
            ) THEN
...
BEGIN
    ...
    WHERE table_schema = 'public'
    AND information_schema.views.table_name = ANY(expected_views);
...
-- 1. Set encryption key: ALTER DATABASE postgres SET app.encryption_key = 'your-secure-key';
...
-- Or execute via command line: psql -U postgres -d your_database -f complete-schema.sql
-- ============================================================================
